...
INSERT INTO "new_Messages" ("createdAt", "deletedAt", "foodForestId", "image", "message", "userId") SELECT "createdAt", "deletedAt", "foodForestId", "image", "message", "userId" FROM "Messages";
DROP TABLE "Messages";
